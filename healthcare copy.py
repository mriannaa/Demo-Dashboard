...
if 'improvement_feedback' in df.columns:
    ...
    with tab_insight:
        st.info(f"""
        **Kesimpulan Evaluasi:**
        * Sebesar **{persen_good:.1f}%** pasien sudah merasa pusing bgt nichhh.
        ...
        **Rekomendasi Tindak Lanjut:**
        1. **Fokus pada aku aja hehehehehehehehe:** Perbaiki segera masalah yang menduduki peringkat teratas pada grafik rincian keluhan, karena itu adalah akar masalah (bottleneck) utama.
